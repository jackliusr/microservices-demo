...
def go_dependencies():
    ...
    go_repository(
        ...
        #cannot specify both commit and replace replace
        #commit = "5563382a8560ea851e6d54962ea71165b2807b24",
        #replace = "https://github.com/googleapis/google-cloud-go",

        # patches/com_google_cloud_go_monitoring.patch
        #patch_args = ["-p2"],
        #patches = [
        #    "//patches:com_google_cloud_go_monitoring.patch",
        #],
    ...
    go_repository(
        ...
        sum = "h1:seMHZtcgOwZXAOKDZuW2sN3u1yKjYG19dUkElb4mbcQ=",
        version = "v0.1.1",
    )
    go_repository(
